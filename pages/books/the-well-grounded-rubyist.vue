  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-grey-300 font-semibold bg-grey-500 px-2">The Well-Grounded Rubyist</p></div>
      </div>
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-purple-500 uppercase font-semibold">Book</p>
            <div class="mt-5 flex items-center">
              <img src="/_nuxt/assets/images/the-well-grounded-rubyist.png" alt="The Well Grounded Rubyist" class="w-16">
              <h2 class="ml-5 text-blue-900 text-5xl">The Well-Grounded Rubyist</h2>
            </div>
          </div>
          <div class="flex items-center border border-orange-900 rounded-full py-1 px-3">
            <span>
              <svg class="fill-current text-orange-900" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M6.012,18H20c0.553,0,1-0.448,1-1V4c0-1.103-0.897-2-2-2H6C4.794,2,3,2.799,3,5v3v6v3v2c0,2.201,1.794,3,3,3h15v-2H6.012 C5.55,19.988,5,19.805,5,19S5.55,18.012,6.012,18z M5,8V5c0-0.805,0.55-0.988,1-1h13v12H5v-2V8z"/><path d="M8 6H17V8H8z"/></svg>
            </span>
            <p class="ml-1 text-orange-900 text-sm font-semibold">#1</p>
          </div>
        </div>
        <div class="mt-5 flex items-center justify-between">
          <div class="flex items-center">
              <a href="https://www.amazon.com/Well-Grounded-Rubyist-David-Black/dp/1617295213/ref=dp_ob_title_bk" target="_blank" class="flex items-center bg-grey-200 rounded-full px-3 py-1 text-grey-700 uppercase font-semibold">
          ...
          <!-- <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://www.ruby-lang.org/en/">https://www.ruby-lang.org/en/</a>
          </div> -->
        </div>
      </section>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">In The Well-Grounded Rubyist, Third Edition, expert authors David A. Black and Joseph Leo III deliver Ruby mastery in an easy-to-read, casual style. You'll lock in core principles as you write your first Ruby programs. Then, you'll progressively build up to topics like reflection, threading, and recursion, cementing your knowledge with high-value exercises to practice your skills along the way.<a href="https://www.amazon.com/Well-Grounded-Rubyist-David-Black/dp/1617295213/ref=dp_ob_title_bk" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col truncate">
            <h3 class="text-black-400 uppercase font-semibold">similar books</h3>
            <nuxt-link to="/books/eloquent-ruby" class="mt-10 flex mb-2 text-black-900 hover:text-black-800">
              Eloquent Ruby
            </nuxt-link>
          </div>
        </div>
...
export default {
  ...
  head () {
    return {
      title: "The Well-Grounded Rubyist - LearnSomething.io",
      meta: [
