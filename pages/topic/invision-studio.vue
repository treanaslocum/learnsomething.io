  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Invision Studio</p></div>
      </div>
      ...
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h2 class="text-blue-900 text-5xl">Invision Studio</h2>
          </div>
        ...
        <div class="mt-5 flex items-center justify-between">
          ...
          <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://www.invisionapp.com/studio" target="_blank">https://www.invisionapp.com/studio</a>
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">A new platform inspired by the world’s best design teams. Design, prototype, and animate—all in one place.<a href="https://www.invisionapp.com/studio" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
        ...
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <div class="mt-10 flex items-center">
              <a href="https://www.invisionapp.com/about" target="_blank">
                <img class="rounded-full" src="~assets/images/invision.jpg" alt="Invision" height="50px" width="50px">
              </a>
              <a href="https://www.invisionapp.com/about" target="_blank" class="ml-5 text-black-900 hover:text-black-800">Invision</a>
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex">
          <div class="flex items-center">
            <p class="mt-10 text-black-900 font-semibold uppercase">Invision Studio Teachers</p>
          </div>
        </div>
        ...
        <div class="mt-16 flex flex-wrap xl:flex-no-wrap">
          ...
          <div class="flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/jp-design-academy">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/jp-design-academy.jpg" alt="JP Design Academy">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/jp-design-academy">
                <p class="ml-5 font-semibold">JP Design Academy</p>
              </nuxt-link>
            </div>
          </div>
...
export default {
  ...
  head () {
    return {
      title: "Invision Studio - LearnSomething.io",
      meta: [
