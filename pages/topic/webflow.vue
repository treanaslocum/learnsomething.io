  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Webflow</p></div>
      </div>
      ...
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h2 class="text-blue-900 text-5xl">Webflow</h2>
          </div>
        ...
        <div class="mt-5 flex items-center justify-between">
          ...
          <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://webflow.com/" target="_blank">https://webflow.com/</a>
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">Webflow, Inc. is an American company, based in San Francisco, that provides software as a service for website building and hosting. Their online visual editor platform allows users to design, build, and launch websites.<a href="https://en.wikipedia.org/wiki/Webflow" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col">
            <h3 class="text-black-400 uppercase font-semibold">similar topics</h3>
            <nuxt-link to="/topic/digital-illustration" class="mt-10 flex mb-2 pointer-events-none text-grey-100 line-through">
              Web Design
        ...
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <div class="mt-10 flex items-center">
              <a href="https://en.wikipedia.org/wiki/Webflow" target="_blank">
                <img class="rounded-full" src="~assets/images/webflow.jpg" alt="Webflow" height="50px" width="50px">
              </a>
              <a href="https://en.wikipedia.org/wiki/Webflow" target="_blank" class="ml-5 text-black-900 hover:text-black-800">Webflow</a>
            </div>    
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex">
          <div class="flex items-center">
            <p class="mt-10 text-black-900 font-semibold uppercase">Webflow Teachers</p>
          </div>
        </div>
        ...
        <div class="mt-16 flex flex-wrap xl:flex-no-wrap">
         ...
         <div class="flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/webflow">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/webflow.jpg" alt="Webflow">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/webflow">
                <p class="ml-5 font-semibold">Webflow</p>
              </nuxt-link>
            </div>
          </div>

          <div class="xl:ml-12 xl:mt-0 lg:mt-12 lg:ml-0 flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/flux">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/flux.jpg" alt="Flux">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/flux">
                <p class="ml-5 font-semibold">Flux</p>
              </nuxt-link>
            </div>
          </div>
          ...
          <div class="xl:ml-12 xl:mt-0 lg:mt-12 lg:ml-0 flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/charli-marie-tv">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/charli-marie-tv.jpg" alt="CharliMarieTV">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/charli-marie-tv">
                <p class="ml-5 font-semibold">CharliMarieTV</p>
              </nuxt-link>
            </div>
          </div>
        </div> 
...
export default {
  ...
  head () {
    return {
      title: "Webflow - LearnSomething.io",
      meta: [
