  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-grey-300 font-semibold bg-grey-500 px-2">CompTIA Network+</p></div>
      </div>
      ...
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h2 class="text-blue-900 text-5xl">CompTIA Network+</h2>
          </div>
        ...
        <div class="mt-5 flex items-center justify-between">
          ...
          <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://www.comptia.org/certifications/network" target="_blank">https://www.comptia.org/certifications/network</a>
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">CompTIA Network+ helps develop a career in IT infrastructure covering troubleshooting, configuring, and managing networks.<a href="https://www.comptia.org/certifications/network#exampreparation" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col">
            <h3 class="text-black-400 uppercase font-semibold">similar topics</h3>
            <nuxt-link to="/topic/cybersecurity" class="mt-10 flex mb-2 text-black-900 hover:text-black-800">Cybersecurity</nuxt-link>
            <nuxt-link to="/topic/cryptography" class="flex mb-2 text-black-900 hover:text-black-800">Cryptography</nuxt-link>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          ...
          <div class="w-1/5 flex flex-col">
            ...
            <a href="https://www.cybrary.it/course/comptia-network-plus/" class="mt-10 flex items-center mb-2 text-black-900 hover:text-black-800">
              Cybrary
      ...
      <section class="mt-20">
        <h3 class="text-black-900 uppercase font-semibold">Learn CompTIA Network+ - video playlists</h3>
        <div class="flex justify-between">
          <div class="">
            <div class="mt-10 flex items-center">
              <div class="flex items-center">
