  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Java</p></div>
      </div>
      ...
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h2 class="text-blue-900 text-5xl">Java</h2>
          </div>
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex">
          <div class="flex items-center">
            <p class="mt-10 text-black-900 font-semibold uppercase">Java Teachers</p>
          </div>
        </div>
