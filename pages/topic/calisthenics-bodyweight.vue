  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <p class="ml-5 text-sm text-blue-900 capitalize"><nuxt-link to="/topics/#fitness">Fitness</nuxt-link> <span class="ml-1 font-semibold">&rsaquo;</span></p>
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Calisthenics & Bodyweight</p></div>
      </div>

      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-purple-500 uppercase font-semibold">Fitness</p>
            <h2 class="text-blue-900 text-5xl">Calisthenics & Bodyweight</h2>
          </div>
        ...
        <div class="mt-5 flex items-center justify-between">
          <div class="flex items-center">
            ...
            <nuxt-link to="../filters/fitness" class="ml-3">
              <p class="bg-grey-200 rounded-full px-3 text-grey-700 uppercase font-semibold hover:text-grey-300">Fitness</p>
            </nuxt-link>
          </div>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 text-black-900 leading-relaxed w-3/5">Calisthenics or callisthenics is a form of exercise consisting of a variety of movements that exercise large muscle groups, such as running, standing, grasping, pushing, etc. These exercises are often performed rhythmically and with minimal equipment, as bodyweight exercises.<a href="https://en.wikipedia.org/wiki/Calisthenics" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col">
            <h3 class="text-black-400 uppercase font-semibold">similar topics</h3>
            <nuxt-link to="/topic/python" class="mt-10 mb-2 pointer-events-none text-grey-100 line-through">Running</nuxt-link>
            <nuxt-link to="/topic/php" class="mb-2 pointer-events-none text-grey-100 line-through">Weight Lifting</nuxt-link>
            <nuxt-link to="/topic/" class="mb-2 pointer-events-none text-grey-100 line-through">Walking</nuxt-link>
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex">
          <div class="flex items-center">
            <p id="ruby-teachers" class="mt-10 text-black-900 font-semibold uppercase">Calisthenics & Bodyweight Teachers</p>
          </div>
        </div>
        ...
        <div class="mt-16 flex flex-wrap xl:flex-no-wrap">
          ...
          <div class="flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/chloe-ting">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/chloe-ting.jpg" alt="Chloe Ting">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/chloe-ting">
                <p class="ml-5 font-semibold">Chloe Ting</p>
              </nuxt-link>
            </div>
          </div>
          ...
          <div class="ml-12 flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/emi-wong">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/emi-wong.jpg" alt="Emi Wong">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/emi-wong">
                <p class="ml-5 font-semibold">Emi Wong</p>
              </nuxt-link>
            </div>
          </div>
          ...
          <div class="ml-12 flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/thenx">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/thenx.jpg" alt="THENX">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/thenx">
                <p class="ml-5 font-semibold">THENX</p>
              </nuxt-link>
            </div>
          </div>
