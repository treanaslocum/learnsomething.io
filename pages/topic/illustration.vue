  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <p class="ml-5 text-sm text-blue-900 capitalize"><nuxt-link to="/topics/#design">Design</nuxt-link> <span class="ml-1 font-semibold">&rsaquo;</span></p>
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Illustration</p></div>
      </div>

      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-purple-500 uppercase font-semibold">Design</p>
            <h2 class="text-blue-900 text-5xl">Illustration</h2>
          </div>
        ...
        <div class="mt-5 flex items-center justify-between">
          <div class="flex items-center">
            ...
            <nuxt-link to="../filters/design" class="ml-3">
              <p class="bg-grey-200 rounded-full px-3 text-grey-700 uppercase font-semibold hover:text-grey-300">Design</p>
            </nuxt-link>
          </div>
          <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://www.adobe.com/products/xd.html" target="_blank">https://www.adobe.com/products/xd.html</a>
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">Adobe XD is a vector-based user experience design tool for web apps and mobile apps, developed and published by Adobe Inc. It is available for macOS and Windows, although there are versions for iOS and Android to help preview the result of work directly on mobile devices.<a href="https://en.wikipedia.org/wiki/Adobe_XD" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col">
            <h3 class="text-black-400 uppercase font-semibold">similar topics</h3>
            <nuxt-link to="/topic/figma" class="flex mt-10 mb-2 text-black-900 hover:text-black-800">
              Figma
            ...
            <nuxt-link to="/topic/invision-studio" class="flex mb-2 text-black-900 hover:text-black-800">
              Invision Studio
              <!-- <svg class="ml-1 fill-current text-red-500" xmlns="http://www.w3.org/2000/svg" width="15" height="24" viewBox="0 0 24 24"><path d="M12.579,2.393c-0.349-0.248-0.808-0.245-1.153,0.006C9.592,3.728,4,8.252,4,14c0,3.247,1.948,6.043,4.734,7.296 C8.275,20.645,8,19.855,8,19c-0.017-3.221,3.558-6.893,3.71-7c0.173-0.124,0.407-0.124,0.579,0C12.441,12.107,16,14.974,16,19.002 c0,0.854-0.275,1.643-0.733,2.294C18.052,20.043,20,17.248,20,14.005C20,8.144,14.418,3.698,12.579,2.393z"/></svg>            -->
            </nuxt-link>
          </div>
        ...
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <div class="mt-10 flex items-center">
              <a href="https://en.wikipedia.org/wiki/Adobe_Systems" target="_blank">
                <img class="rounded-full" src="~assets/images/adobe.jpg" alt="Adobe" height="50px" width="50px">
              </a>
              <a href="https://en.wikipedia.org/wiki/Adobe_Systems" target="_blank" class="ml-5 text-black-900 hover:text-black-800">Adobe</a>
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex">
          <div class="flex items-center">
            <p class="mt-10 text-black-900 font-semibold uppercase">Illustration Teachers</p>
          </div>
        </div>
        ...
        <div class="mt-16 flex flex-wrap xl:flex-no-wrap">
          ...
          <div class="flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/caler-edwards">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/caler-edwards.jpg" alt="Caler Edwards">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/caler-edwards">
                <p class="ml-5 font-semibold">Caler Edwards</p>
              </nuxt-link>
            </div>
          </div>

          <div class="ml-12 flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/jesse-showalter">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/jesse-showalter.jpg" alt="Jesse Showalter">
            </nuxt-link>            
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/jesse-showalter">
                <p class="ml-5 font-semibold">Jesse Showalter</p>
              </nuxt-link>
            </div>
          </div>
...
export default {
  ...
  head () {
    return {
      title: "Illustration - LearnSomething.io",
      meta: [
