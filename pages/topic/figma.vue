  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Figma</p></div>
      </div>
      ...
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h2 class="text-blue-900 text-5xl">Figma</h2>
          </div>
        ...
        <div class="mt-5 flex items-center justify-between">
          ...
          <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://www.figma.com/" target="_blank">https://www.figma.com/</a>
          </div>
        </div>
      </section>
          ...
          <div class="w-4/5">
            ...
            <div class="mt-10 flex items-center">
              <a href="https://en.wikipedia.org/wiki/Figma_(software)" target="_blank">
                <img class="rounded-full" src="~assets/images/figma.jpg" alt="Figma" height="50px" width="50px">
              </a>
              <a href="https://en.wikipedia.org/wiki/Figma_(software)" target="_blank" class="ml-5 text-black-900 hover:text-black-800">Figma</a>
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex">
          <div class="flex items-center">
            <p class="mt-10 text-black-900 font-semibold uppercase">Figma Teachers</p>
          </div>
        </div>
        ...
        <div class="mt-16 flex flex-wrap xl:flex-no-wrap">
          ...
          <div class="flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/dev-ed">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/dev-ed.jpg" alt="Dev Ed">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/dev-ed">
                <p class="ml-5 font-semibold">Dev Ed</p>
              </nuxt-link>
            </div>
          </div>
