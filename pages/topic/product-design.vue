  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Product Design</p></div>
      </div>
      ...
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h2 class="text-blue-900 text-5xl">Product Design</h2>
          </div>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">Product design as a verb is to create a new product to be sold by a business to its customers. A very broad coefficient and effective generation and development of ideas through a process that leads to new products. <a href="https://en.wikipedia.org/wiki/Product_design" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col">
            <h3 class="text-black-400 uppercase font-semibold">similar topics</h3>
            <nuxt-link to="/topic/ui-design" class="flex mt-10 mb-2 text-black-900 hover:text-black-800">
              UI Design
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex">
          <div class="flex items-center">
            <p class="mt-10 text-black-900 font-semibold uppercase">Product Design XD Teachers</p>
          </div>
        </div>
        ...
        <div class="mt-16 flex flex-wrap xl:flex-no-wrap">
          ...
          <div class="xl:mt-0 lg:mt-12 flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/aj-smart">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/aj-smart.jpg" alt="AJ&Smart">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/aj-smart">
                <p class="ml-5 font-semibold">AJ&Smart</p>
              </nuxt-link>
            </div>
          </div>
...
export default {
  ...
  head () {
    return {
      title: "Product Design - LearnSomething.io",
      meta: [
