  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Futures</p></div>
      </div>
      ...
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h2 class="text-blue-900 text-5xl">Futures</h2>
          </div>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 text-black-900 leading-relaxed w-3/5">In finance, a futures contract is a standardized legal agreement to buy or sell something at a predetermined price at a specified time in the future, between parties not known to each other. The asset transacted is usually a commodity or financial instrument.<a href="https://en.wikipedia.org/wiki/Futures_contract" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col">
            <h3 class="text-black-400 uppercase font-semibold">similar topics</h3>
            <nuxt-link to="/topic/options" class="mt-10 mb-2 text-black-900 hover:text-black-800">Options</nuxt-link>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          ...
          <div class="w-1/5 flex flex-col">
            ...
            <a href="https://www.tdameritrade.com/investment-products/futures-trading.page" target="_blank" class="mt-10 flex items-center mb-2 text-black-900 hover:text-black-800">
              TD Ameritrade
              <div class="ml-3 bg-grey-300 text-white text-xs font-semibold rounded uppercase px-2">free</div>
            </a>
            <a href="https://www.investopedia.com/terms/f/futurescontract.asp" target="_blank" class="flex items-center mb-2 text-black-900 hover:text-black-800">
              Investopedia
              <div class="ml-3 bg-grey-300 text-white text-xs font-semibold rounded uppercase px-2">free</div>
            </a>
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex">
          <div class="flex items-center">
            <p id="ruby-teachers" class="mt-10 text-black-900 font-semibold uppercase">Futures Teachers</p>
          </div>
        </div>
        ...
        <div class="mt-16 flex flex-wrap xl:flex-no-wrap">
          ...
          <div class="flex items-center flex-shrink-0">
            <nuxt-link to="../teacher/clay-trader">
              <img class="rounded-full" height="70px" width="70px" src="~assets/images/teachers/clay-trader.jpg" alt="Mike Dane">
            </nuxt-link>
            <div class="flex flex-col flex-wrap lg:flex-no-wrap xl:flex-no-wrap">
              <nuxt-link to="../teacher/clay-trader">
                <p class="ml-5 font-semibold">ClayTrader</p>
              </nuxt-link>
            </div>
          </div>
