  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Pre-algebra</p></div>
      </div>
      ...
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h2 class="text-blue-900 text-5xl">Pre-algebra</h2>
          </div>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 text-black-900 leading-relaxed w-3/5">Pre-algebra is a common name for a course in middle school mathematics. In the United States, pre-algebra is usually taught in the 6th grade or 7th grade. The objective of it is to prepare students for the study of algebra.<a href="https://en.wikipedia.org/wiki/Pre-algebra" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col">
            <h3 class="text-black-400 uppercase font-semibold">similar topics</h3>
            <nuxt-link to="/topic/algebra-one" class="mt-10 flex mb-2 text-black-900 hover:text-black-800">Algebra 1</nuxt-link>
            <nuxt-link to="/topic/geometry" class="mb-2 pointer-events-none text-grey-100 line-through">Geometry</nuxt-link>
            <nuxt-link to="/topic/algebra-two" class="mb-2 pointer-events-none text-grey-100 line-through">Algebra 2</nuxt-link>
          </div>
        </div>
      </section>
        ...
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <div class="mt-10 flex items-center">
              <a href="https://en.wikipedia.org/wiki/Muhammad_ibn_Musa_al-Khwarizmi" target="_blank">
                <img class="rounded-full" src="~assets/images/muhammad-ibn-musa.jpg" alt="Muhammad ibn Musa al-Khwarizmi" height="50px" width="50px">
              </a>
              <a href="https://en.wikipedia.org/wiki/Muhammad_ibn_Musa_al-Khwarizmi" target="_blank" class="ml-5 text-black-900 hover:text-black-800">Muhammad ibn Musa al-Khwarizmi</a>
              
            </div> 
            <div class="mt-10 flex items-center">
              <a href="https://en.wikipedia.org/wiki/Diophantus" target="_blank">
                <img class="rounded-full" src="~assets/images/diophantus.jpg" alt="Diophantus" height="50px" width="50px">
              </a>
              <a href="https://en.wikipedia.org/wiki/Diophantus" target="_blank" class="ml-5 text-black-900 hover:text-black-800">Diophantus</a>
            </div>
          </div>
          <div class="w-1/5 flex flex-col">
            ...
            <a href="https://ocw.mit.edu/index.htm" target="_blank" class="flex mb-2 items-center text-black-900 hover:text-black-800">
              MIT OpenCourseWare
              <div class="ml-3 bg-grey-300 text-white text-xs font-semibold rounded uppercase px-2">free</div>
            </a>
          </div>
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex">
          <div class="flex items-center">
            <p class="mt-10 text-black-900 font-semibold uppercase">Pre-Algebra Teachers</p>
          </div>
        </div>
...
export default {
  ...
  head () {
    return {
      title: "Pre-algebra - LearnSomething.io",
      meta: [
