  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-grey-300 font-semibold bg-grey-500 px-2">Ruby</p></div>
      </div>
      ...
      <section class="mt-12">
        ...
        <div class="mt-5 flex items-center justify-between">
          <div class="flex items-center">
            ...
            <p class="ml-3 bg-grey-200 rounded-full px-3 text-grey-700 uppercase font-semibold">Programming Language</p>
          </div>
          <div>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <div class="mt-10 flex items-center">
              <img class="" src="~assets/images/yukihiro-matsumoto.jpg" alt="Yukihiro Matsumoto" height="50px" width="50px">
