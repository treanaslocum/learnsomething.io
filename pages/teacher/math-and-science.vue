  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        <p class="text-sm text-blue-900 capitalize"><nuxt-link to="/topic/physics">Physics</nuxt-link> <span class="ml-1 font-semibold">&rsaquo;</span></p>
        <p class="ml-3 text-sm text-blue-900 capitalize"><nuxt-link to="/topic/physics">Teachers</nuxt-link> <span class="ml-1 font-semibold">&rsaquo;</span></p>
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Math and Science</p></div>
      </div>
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-purple-500 uppercase font-semibold">Teacher</p>
            <h2 class="text-blue-900 text-5xl">Math and Science</h2>
          </div>
        </div>
        <div class="mt-5 flex items-center justify-between">
          ...
          <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://www.mathtutordvd.com/" target="_blank">https://www.mathtutordvd.com/</a>
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">Quality Math And Science Videos that feature step-by-step example problems!<a href="https://www.youtube.com/user/mathtutordvd/featured" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
...
export default {
  ...
  head () {
    return {
      title: "Math and Science - LearnSomething.io",
      meta: [
