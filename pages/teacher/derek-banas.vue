      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex items-center">
          <div class="max-w-sm rounded overflow-hidden">
            <iframe width="400" height="200" src="https://www.youtube.com/embed/Dji9ALCgfpM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="px-6 py-4">
          ...
          <div class="ml-10 max-w-sm rounded overflow-hidden">
            <iframe width="400" height="200" src="https://www.youtube.com/embed/fju9ii8YsGs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="px-6 py-4">
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#beginner</span>
          ...
          <div class="ml-10 max-w-sm rounded overflow-hidden">
           <iframe width="400" height="200" src="https://www.youtube.com/embed/n-xAqcBCws4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="px-6 py-4">
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#beginner</span>
