    ...
    <div class="mt-32 px-32">
      ...
      <section class="mt-12">
        ...
        <div class="mt-5 flex items-center justify-between">
          ...
          <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://www.video-tutor.net/" target="_blank">https://www.video-tutor.net/</a>
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">This channel focuses on providing tutorial videos on organic chemistry, general chemistry, physics, algebra, trigonometry, precalculus, and calculus.<a href="https://www.youtube.com/c/TheOrganicChemistryTutor/featured" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex items-center flex-wrap">           
          ...
          <div class="rounded overflow-hidden">
            <iframe width="480" height="270" src="https://www.youtube.com/embed/videoseries?list=PL0o_zxa4K1BX8lFpIiKY97cHfKp7JP2NV" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
            <div class="px-6 py-4">
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#biology</span>
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">total duration 7 hours, 42 minutes</span>
            </div>
          </div>
        ...
        <div class="mt-12 flex items-center flex-wrap">           
          ...
          <div class="rounded overflow-hidden">
            <iframe width="480" height="270" src="https://www.youtube.com/embed/videoseries?list=PL0o_zxa4K1BV-uX6wXQgyqZXvRd0tUUV0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>      
            <div class="px-6 py-4">
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#chemistry</span>
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">total duration 1 day, 20 hours, 8 minutes</span>
            </div>
          </div>
...
export default {
  ...
  head () {
    return {
      title: "The Organic Chemistry Tutor - LearnSomething.io",
      meta: [
