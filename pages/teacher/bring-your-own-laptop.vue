  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        <p class="text-sm text-blue-900 capitalize"><nuxt-link to="/topic/html-css">HTML & CSS</nuxt-link> <span class="ml-1 font-semibold">&rsaquo;</span></p>
        <p class="ml-3 text-sm text-blue-900 capitalize"><nuxt-link to="/topic/html-css">Teachers</nuxt-link> <span class="ml-1 font-semibold">&rsaquo;</span></p>
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Bring Your On Laptop</p></div>
      </div>
      <section class="mt-12">
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex items-center">
          <div class="max-w-sm rounded overflow-hidden">
            <iframe width="400" height="200" src="https://www.youtube.com/embed/C5QFHp1oAws" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="px-6 py-4">
