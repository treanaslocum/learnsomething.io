            ...
            <div class="mt-10 flex items-center">
              <div class="flex items-center">
                <nuxt-link to="../teacher/geeks-lesson">
                  <img class="rounded-full" src="~assets/images/teachers/geek's-lesson.jpg" alt="Geeks Lesson" height="50px" width="50px">
                </nuxt-link>
                <nuxt-link to ="../teacher/geeks-lesson" class="ml-5 text-black-900 hover:text-black-800">Geek's Lesson</nuxt-link>
              </div>
