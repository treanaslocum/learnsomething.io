  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Deanin</p></div>
      </div>
      <section class="mt-12">
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex items-center">
          <div class="max-w-sm rounded overflow-hidden">
              <iframe width="400" height="200" src="https://www.youtube.com/embed/KIccv7QVfFQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>           <div class="px-6 py-4">
          ...
          <div class="ml-10 max-w-sm rounded overflow-hidden">
            <iframe width="400" height="200" src="https://www.youtube.com/embed/videoseries?list=PL3mtAHT_eRexS2EjF6V9ZUXkETOrvdzy2" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="px-6 py-4">
          ...
          <div class="ml-10 max-w-sm rounded overflow-hidden">
           <iframe width="400" height="200" src="https://www.youtube.com/embed/videoseries?list=PL3mtAHT_eRez6d-PavT6O1KtcMe7mOr-C" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="px-6 py-4">
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#mixed</span>
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#ruby on rails</span>
            </div>
