    ...
    <div class="mt-32 px-32">
      ...
      <section class="mt-12">
        <div class="flex items-center">
          <div>
            <img src="~/assets/images/teachers/clay-trader.jpg" alt="Clay Trader" class="rounded-full h-24">
          </div>
          <div class="ml-10">
            <p class="text-purple-500 uppercase font-semibold">Teacher</p>
            <h2 class="text-blue-900 text-5xl">ClayTrader</h2>
          </div>
        </div>
        <div class="mt-5 flex items-center justify-between">
          <div class="flex items-center">
            <a href="https://twitter.com/claytrader25" target="_blank" class="flex items-center text-grey-700 uppercase font-semibold">
          ...
          <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://claytrader.com/" target="_blank">https://claytrader.com/</a>
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">I am a full time stock trader, teacher, and blogger. Technical analysis and charts are the foundations to my success. I enjoy blogging and helping others become better traders. I am the #1 Most Followed member of the largest small cap message board in the world: Investorshub.com <a href="https://www.youtube.com/c/Claytrader/featured" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col truncate">
            <h3 class="text-black-400 uppercase font-semibold">topics I teach</h3>
            <nuxt-link to="/topic/futures" class="mt-10 flex mb-2 text-black-900 hover:text-black-800">
              Futures
            ...
            <nuxt-link to="/topic/stocks" class="flex mb-2 text-grey-100 line-through">
              Stocks
              <!-- <svg class="ml-1 fill-current text-red-500" xmlns="http://www.w3.org/2000/svg" width="15" height="24" viewBox="0 0 24 24"><path d="M12.579,2.393c-0.349-0.248-0.808-0.245-1.153,0.006C9.592,3.728,4,8.252,4,14c0,3.247,1.948,6.043,4.734,7.296 C8.275,20.645,8,19.855,8,19c-0.017-3.221,3.558-6.893,3.71-7c0.173-0.124,0.407-0.124,0.579,0C12.441,12.107,16,14.974,16,19.002 c0,0.854-0.275,1.643-0.733,2.294C18.052,20.043,20,17.248,20,14.005C20,8.144,14.418,3.698,12.579,2.393z"/></svg> -->
            </nuxt-link>
          </div>
      ...
      <section class="mt-20">
        ...
        <h4 class="mt-16 text-xl font-semibold">Futures</h4>

        <div class="mt-12 flex items-center">
          <div class="rounded overflow-hidden">
            <iframe width="480" height="270" src="https://www.youtube.com/embed/videoseries?list=PL8Mv8LrQ0-yQjPDBQAM6cW9PuJJ-Wc0FQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="px-6 py-4">
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#beginner</span>
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#futures</span>
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">total duration 2:18:44</span>
            </div>
          </div>
        </div> 
...
export default {
  ...
  head () {
    return {
      title: "ClayTrader - LearnSomething.io",
      meta: [
