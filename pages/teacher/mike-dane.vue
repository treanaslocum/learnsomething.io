  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <p class="ml-3 text-sm text-blue-900 capitalize"><nuxt-link to="/topic/ruby/#intro-teachers">Teachers</nuxt-link> <span class="ml-1 font-semibold">&rsaquo;</span></p>
        <div class="ml-5"><p class="text-xs text-grey-700 font-semibold bg-grey-500 px-2">Mike Dane</p></div>
      </div>
      <section class="mt-12">
        ...
        <div class="mt-5 flex items-center justify-between">
          <div class="flex items-center">
              <a href="https://twitter.com/mike_dane?lang=en" target="_blank" class="flex items-center bg-grey-200 rounded-full px-3 py-1 text-grey-700 uppercase font-semibold">
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cumque sint provident consequuntur exercitationem. Nulla, non?<a href="https://www.youtube.com/channel/UCvmINlrza7JHB1zkIOuXEbw" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
      ...
      <section class="mt-20">
        <h3 class="text-black-900 uppercase font-semibold">Playlists Categories</h3>
        <div class="mt-12 flex items-center">
          <div class="max-w-sm rounded overflow-hidden shadow-lg">
            <img class="w-full" src="/img/card-top.jpg" alt="Sunset in the mountains">
            <div class="px-6 py-4">
              <div class="font-bold text-xl mb-2">Prerequisites</div>
              <p class="text-gray-700 text-base">
                Before taking this course, it's preferred that you have some experience with fundamental coding concepts. Here’s our suggested resources to get you up to speed. <span class="text-purple-400 hover:text-purple-600 capitalize">Intro to computer programming</span>, <span class="text-purple-400 hover:text-purple-600">HTML</span>, <span class="text-purple-400 hover:text-purple-600">JavaScript</span>.
              </p>
            </div>
            <div class="px-6 py-4">
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#current_subject</span>
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#parent_subject</span>
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700">#teacher_name</span>
            </div>
          </div>
          <div class="max-w-sm rounded overflow-hidden shadow-lg">
            <img class="w-full" src="/img/card-top.jpg" alt="Sunset in the mountains">
