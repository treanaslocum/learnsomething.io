    ...
    <div class="mt-32 px-32">
      ...
      <section class="mt-12">
        <div class="flex items-center">
          <div>
            <img src="~/assets/images/teachers/mike_dane.jpg" alt="Mike Dane" class="rounded-full h-24">
          </div>
          <div class="ml-10">
            <p class="text-purple-500 uppercase font-semibold">Teacher</p>
            <h2 class="text-blue-900 text-5xl">Mike Dane</h2>
          </div>
        </div>
        <div class="mt-5 flex items-center justify-between">
          <div class="flex items-center">
              <a href="https://twitter.com/mike_dane?lang=en" target="_blank" class="flex items-center text-grey-700 uppercase font-semibold">
          ...
          <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://www.mikedane.com/" target="_blank">https://www.mikedane.com/</a>
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">Hey! My name’s Mike Dane, and I’ve got one simple goal, to create the highest quality and entertaining educational content on the internet.<a href="https://www.youtube.com/channel/UCvmINlrza7JHB1zkIOuXEbw" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col truncate">
            ...
            <nuxt-link to="/topic/python" class="flex text-black-900 hover:text-black-800">
              Python
            </nuxt-link>
          </div>
        </div>
            ...
            <div class="mt-10 flex items-center">
              ...
              <div class="ml-10 flex items-center">
                <nuxt-link to="../teacher/boris-paskhaver">
                  <img class="rounded-full" src="~assets/images/teachers/boris-paskhaver.jpg" alt="Boris Paskhaver" height="50px" width="50px">
                </nuxt-link>
                <nuxt-link to ="../teacher/boris-paskhaver" class="ml-5 text-black-900 hover:text-black-800">Boris Paskhaver</nuxt-link>
              </div>
               ...
               <div class="ml-10 flex items-center">
                ...
                <nuxt-link to ="../teacher/boris-paskhaver" class="ml-5 text-black-900 hover:text-black-800">Tech With Tim</nuxt-link>
              </div>
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex items-center">
          <div class="rounded overflow-hidden">
            <iframe width="480" height="270" src="https://www.youtube.com/embed/videoseries?list=PLLAZ4kZ9dFpO90iMas70Tt4_wYjhLGkya" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="px-6 py-4">
              ...
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">total duration 4:14:30</span>
            </div>
          </div>          
        </div> 
        ...
        <div class="mt-12 flex items-center">
            <div class="rounded overflow-hidden">
              ...
              <div class="px-6 py-4">
                ...
                <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">total duration 3:52:26</span>
              </div>
          </div>
        </div>
        ...
        <div class="mt-12 flex items-center">
          ...
          <div class="rounded overflow-hidden">
            ...
            <div class="px-6 py-4">
              ...
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">total duration 4:38:11</span>
            </div>
          </div>
        </div>
        ...
        <div class="mt-12 flex items-center">
            ...
            <div class="px-6 py-4">
              ...
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">total duration 5:49:20</span>
            </div>
          </div>
        </div> 
...
export default {
  ...
  head () {
    return {
      title: "Mike Dane - LearnSomething.io",
      meta: [
