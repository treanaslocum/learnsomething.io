    ...
    <div class="mt-32 px-32">
      ...
      <section class="mt-12">
        <div class="flex items-center">
          <div>
            <img src="~/assets/images/teachers/dani-krossing.jpg" alt="Dani Krossing" class="rounded-full h-24">
          </div>
          <div class="ml-10">
      ...
      <section class="mt-20">
        ...
        <div class="mt-12 flex items-center">
          <div class="rounded overflow-hidden">
            <iframe width="480" height="270" src="https://www.youtube.com/embed/videoseries?list=PL0eyrZgxdwhwNC5ppZo_dYGVjerQY3xYU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="px-6 py-4">
              ...
              <span class="inline-block bg-grey-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">total duration 10:32:11</span>
            </div>
          </div>
