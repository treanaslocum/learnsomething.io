  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        <p class="text-sm text-blue-900 capitalize"><nuxt-link to="/topic/java">Java</nuxt-link> <span class="ml-1 font-semibold">&rsaquo;</span></p>
        <p class="ml-3 text-sm text-blue-900 capitalize"><nuxt-link to="/topic/java">Teachers</nuxt-link> <span class="ml-1 font-semibold">&rsaquo;</span></p>
        <div class="ml-5"><p class="text-xs text-blue-900 font-semibold px-2">Caleb Curry</p></div>
      </div>
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-purple-500 uppercase font-semibold">Teacher</p>
            <h2 class="text-blue-900 text-5xl">Caleb Curry</h2>
          </div>
        </div>
        <div class="mt-5 flex items-center justify-between">
          ...
          <div>
            <a class="mt-5 text-black-900 hover:text-black-800" href="https://www.calebcurry.tech/" target="_blank">https://www.calebcurry.tech/</a>
          </div>
        </div>
      </section>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">I've decided that it is only right to upload videos of great quality and value.  Here you will find videos on C++, JavaScript, C, database design, SQL, and more!  As a side note, many videos contain horribly cheesy jokes and random stories...you've been warned. <a href="https://www.youtube.com/channel/UCZUyPT9DkJWmS_DzdOi7RIA" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
          <div class="w-1/5 flex flex-col truncate">
            <h3 class="text-black-400 uppercase font-semibold">topics I teach</h3>
            <nuxt-link to="/topic/databases" class="mt-10 mb-2 text-grey-100 line-through">
              Database Design
            ...
            <nuxt-link to="/topic/c++" class="flex mb-2 text-grey-100 line-through">
              c++
            </nuxt-link>
...
export default {
  ...
  head () {
    return {
      title: "Caleb Curry - LearnSomething.io",
      meta: [
