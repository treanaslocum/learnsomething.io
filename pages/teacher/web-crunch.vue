    ...
    <div class="mt-32 px-32">
      ...
      <section class="mt-12">
        <div class="flex items-center">
          <div>
            <img src="~/assets/images/teachers/web-crunch.jpg" alt="Web Crunch" class="rounded-full h-24">
          </div>
          <div class="ml-10">
        ...
        <div class="mt-5 flex items-center justify-between">
          <div class="flex items-center">
              <a href="https://twitter.com/webcrunchblog" target="_blank" class="flex items-center text-grey-700 uppercase font-semibold">
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">This channel is the home for all videos uploaded to Web-Crunch.com. Web-Crunch is a blog about design, development, and entrepreneurship. We hope you'll subscribe for future videos!<a href="https://www.youtube.com/c/Webcrunch/featured" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
