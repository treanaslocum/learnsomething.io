  ...
  <div class="body">
    ...
    <div class="mt-32 px-32">
      <div class="flex items-center">
        ...
        <div class="ml-5"><p class="text-xs text-grey-300 font-semibold bg-grey-500 px-2">Web-Crunch</p></div>
      </div>
      <section class="mt-12">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-purple-500 uppercase font-semibold">Teacher</p>
            <h2 class="text-blue-900 text-5xl">Web-Crunch</h2>
          </div>
        </div>
      ...
      <section class="mt-20">
        <div class="flex justify-between">
          <div class="w-4/5">
            ...
            <p class="mt-10 leading-relaxed w-3/5">This channel is the home for all videos uploaded to Web-Crunch.com. Web-Crunch is a blog about design, development, and entrepreneurship. We hope you'll subscribe for future videos!<a href="https://www.youtube.com/user/webcrunchblog/featured" target="_blank" class="ml-1 text-lg text-purple-500 font-semibold">&rsaquo;&rsaquo;</a></p>
          </div>
      ...
      <section class="mt-20">
        <h3 class="text-black-900 uppercase font-semibold">Learn Ruby on Rails</h3>
        <div class="flex justify-between">
          <div class="">
            <div class="mt-10 flex items-center">
              <div class="flex items-center">
                <div class=""><p class="text-xs bg-blue-900 text-white font-semibold px-2 uppercase">English</p></div>
              </div>
            </div> 
            <div class="flex items-center">
              <div class="">
...
export default {
  ...
  head () {
    return {
      title: "Web-Crunch - LearnSomething.io",
      meta: [
